...
mousePressEvent(QMouseEvent *e)
{
  ...
  callEventListener("mousedown", "onmousedown", event, nameValues);
}
...
mouseMoveEvent(QMouseEvent *e)
{
  ...
  callEventListener("mousemove", "onmousemove", event, nameValues);
}
...
mouseReleaseEvent(QMouseEvent *e)
{
  ...
  callEventListener("mouseup", "onmouseup", event, nameValues);

  callEventListener("click", "onclick", event, nameValues);
}
